...
// configure
$from = 'mail@saurabhbansal.me'; // Replace it with Your Hosting Admin email. REQUIRED!
$sendTo = 'mail@saurabhbansal.me'; // Replace it with Your email. REQUIRED!
...
if(isset($_POST['g-recaptcha-response']) && !empty($_POST['g-recaptcha-response'])):
    ...
    $secret = '6Lc7500eAAAAAFA6RPtDzlDVyWxkCTv8tl2FjhYt';
